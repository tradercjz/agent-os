...
protected:
  ...
  void TearDown() override {
    ...
    std::filesystem::remove_all(
        std::filesystem::temp_directory_path() / "agentos_ref_test_snap");
    std::filesystem::remove_all(
        std::filesystem::temp_directory_path() / "agentos_ref_test_ltm");
  }
